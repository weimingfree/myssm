...
<script type="text/javascript">
    ...
    //单个删除
    function del(cid,tid) {
        //弹框提示
        if (confirm("确定退授吗")) {
            //发出ajax的请求，向服务器提交请求完成删除
            $.ajax({
                url:"${pageContext.request.contextPath}/grantedCourse/delete.action",
                data:{"cid":cid,"tid":tid},
                type:"post",
                dataType:"text",
                success:function (msg){
                    alert(msg);
                    $("#table").load("http://localhost:8080/admin/teacher/grantedCourse.jsp #table");
                }
            });
        }
    }
